...
la seña. */
	public class Evento
	{
		...
		private ArrayList Lista_Servicios_Contrado;
		private ArrayList Lista_Empleados_Contrado;
		...
		public Evento(Cliente cli, DateTime FHE, string tipoE,Encargado en,float CostoT, float Sen)
		{
			...
			this.encargado= en;
			this.Lista_Servicios_Contrado= new ArrayList();
			this.Lista_Empleados_Contrado=new ArrayList();
		...
		public ArrayList LISTA_SERVICIOS_CONTRATADOS
		{
			get{return Lista_Servicios_Contrado;}
			set{Lista_Servicios_Contrado= value;}
		}
		
		public ArrayList LISTA_EMPLEADOS_CONTRATADOS
		{
