				...
				switch (respuesta) //MENU
				{
					...
					case "E":
						...
						try
						{
							...
							foreach (Encargado x in Aura_Real.LISTA_EMPLEADOS)
							{
							...
							if(encar == null)
							{
								Console.WriteLine("No hay encargados disponibles.No es puede crear el evento.");
								break;
							}
							else
							{
